...
public class UpdateTransactionDto {
    ...
    public UpdateTransactionDto(CustomerModel sender, Date dueDate, String description, String customerCpfCnpj, BigDecimal amount) {
        this.sender = sender;
    ...
    public UpdateTransactionDto(CustomerModel sender, ApiTransactionRequestDto requestDto) {
